        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1, alignItems: 'center' }}>
                    ...
                    <View style={{ width: DEVICE_WIDTH }}>
                        <Text style={[styles.bold, { fontSize: 22, backgroundColor: '#FADBD8', borderRadius: 20, color: secondaryColor, alignSelf: 'flex-start', paddingLeft: 12, marginTop: 10 }]}>“ การรับรู้รายรับ ”    </Text>
                    </View>
                    <View style={{ flexDirection: 'row', padding: 2, marginTop: 5 }}>
                        <View style={{ flex: 0.3 }}>
                            <TouchableOpacity style={{ width: 105, height: 105 }}
                        ...
                        <View style={{ flex: 0.3 }}>
                            <TouchableOpacity style={{ width: 105, height: 105 }}
                                ...
                                <LinearGradient colors={['#F1948A', '#EC7063', '#E74C3C']} style={{ flex: 1, justifyContent: 'center', alignItems: 'center', borderRadius: 5 }}>
                                    ...
                                    <Text style={[styles.bold, { fontSize: 17, color: 'white', marginTop: 5 }]}>รายงานค่าคอมมิชชั่น</Text>
                                </LinearGradient>
                            </TouchableOpacity>
                        </View>
                        <View style={{ width: 5 }} />
